...
`D-005`も2026年8月16日に確定。Appleカレンダー連携、簡易共有、体験記録、ウィジェットはValidation ReleaseのWon'tとし、Phase 2 / 2.5後の正式v1計画で再評価する。次は`P0-PROD-04`でD-004 / D-005をMust / May / Won'tへ固定する。
