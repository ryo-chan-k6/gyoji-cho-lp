...
|---|---|---|---|---|
| D-001 | 最優先ユーザー | 妊娠後期、出産直後、0〜1歳第一子家庭等 | P0-PROD-01完了前 | P0-PROD-01、P0-MKT-01 |
| D-002 | MLP対象の家族固有行事 | お宮参り、お食い初め、初節句、1歳祝い等の優先順位 | P0-PROD-02完了前 | P0-PROD-02〜04 |
| D-003 | MLP対象の季節文化 | 件数、選定基準、「利用の谷」を検証できる時期 | P0-PROD-02完了前 | P0-PROD-02〜04 |
| D-004 | MLPの必須／非対象 | 「やってみる」、準備CTA、通知等のMust判定 | P0-PROD-04完了前 | Phase 1 Product / Data |
...
| 本Chat | D-018〜020 | **確定済み（2026-08-16）**：Phase 0の期限、責任者稼働、費用上限 |
