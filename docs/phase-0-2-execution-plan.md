...
| P0-PROD-04 | MLPのMust / May / Won'tを固定する | MLP scope / frozen backlog | P0-PROD-03, `D-004`, `D-005`, `D-017`, `D-021` | 必須機能、採否保留、非対象、追加変更条件、開発上限が明記されている |
...
| D-005 | MLP追加候補 | Appleカレンダー連携、簡易共有、体験記録、ウィジェットはValidation ReleaseのWon't | **2026-08-16確定** | P0-PROD-04、P1-PROD-01 |
...
| D-017 | 準備意向CTA | 「写真の準備を見る」等の中立CTA→アプリ内ガイド。クリックは準備情報への関心であり、購入・収益性の証拠にしない | **2026-08-16確定** | P0-PROD-04、P0-DATA-03、Phase 1 Product |
...
| D-021 | Phase 1開発上限 | 目標8週／224時間、上限10週／280時間、週28時間、追加開発費0円。外注・有料SDK・有料バックエンドなし | **2026-08-16確定** | P0-PROD-04、P0-VAL-04、P0-GATE-02、Phase 1全タスク |
